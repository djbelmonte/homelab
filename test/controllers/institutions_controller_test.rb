...
class InstitutionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create institution" do
    assert_difference("Institution.count") do
      post institutions_url, params: { institution: { address: @institution.address, contact_number: @institution.contact_number, name: @institution.name } }
    end
  ...
  test "should update institution" do
    patch institution_url(@institution), params: { institution: { address: @institution.address, contact_number: @institution.contact_number, name: @institution.name } }
